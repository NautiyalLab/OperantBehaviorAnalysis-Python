...
def RVI_Go_NoGo_P2(loaded_file, i):
    ...
    small_nogo_latency = RVI_nogo_latency(timecode, eventcode, 'NoGoTrialBegSmallReward')
    large_nogo_latency = RVI_nogo_latency(timecode, eventcode, 'NoGoTrialBegLargeReward')
