...
if leverpress == 1:
    for i in range(len(lever_press)):
        ...
        ax.scatter(timecode[lever_press_idx], 1, color='m', s=12, marker='.')
    ax.scatter(timecode[lever_press_idx], 1, color='m', marker='.', s=12, label='Lever Press')
...
fig.savefig('pythonplot1.png')  # saving figure as image
