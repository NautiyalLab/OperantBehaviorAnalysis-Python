...
print(df.groupby(['Day', 'Condition'])['Click Responding', 'Noise Responding'].mean().unstack().to_string())
print(df.groupby(['Day', 'Condition'])['Click Responding', 'Noise Responding'].sem().unstack().to_string())
