...
group_means = df.groupby(['Day', 'Condition'])['Click Responding', 'Noise Responding'].mean()
group_sems = df.groupby(['Day', 'Condition'])['Click Responding', 'Noise Responding'].sem()

print(df.groupby(['Day', 'tts', 'Condition'])['Click Responding', 'Noise Responding'].mean().unstack().to_string())
print(df.groupby(['Day', 'tts', 'Condition'])['Click Responding', 'Noise Responding'].sem().unstack().to_string())
