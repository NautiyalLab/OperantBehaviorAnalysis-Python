...
column_list = ['Subject', 'tTs', 'Day', 'Dippers', 'Go Trials', 'No Go Trials', 'Successful Go Trials',
...
group_means = df.groupby(['Day', 'tts'])['Dippers', 'Successful Go Trials', 'Successful No Go Trials'].mean()
group_sems = df.groupby(['Day', 'tts'])['Dippers', 'Successful Go Trials', 'Successful No Go Trials'].sem()

print(df.groupby(['Day', 'tts'])['Dippers', 'Successful Go Trials', 'Successful No Go Trials'].mean().unstack().to_string())
print(df.groupby(['Day', 'tts'])['Dippers', 'Successful Go Trials', 'Successful No Go Trials'].sem().unstack().to_string())
