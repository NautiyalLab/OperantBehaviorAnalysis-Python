...
def RVI_Go_NoGo_P3(loaded_file, i):
    """
    ...
    small_nogo_latency = RVI_nogo_latency(timecode, eventcode, 'NoGoTrialBegSmallReward', 10)
    large_nogo_latency = RVI_nogo_latency(timecode, eventcode, 'NoGoTrialBegLargeReward', 10)
...
(days, df) = loop_over_days(column_list, RVI_Go_NoGo_P3)
print(df.to_string())
