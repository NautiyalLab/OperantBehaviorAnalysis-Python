...
df4means.to_excel("summarydata.xlsx") # rows are total licks, total bouts, mean bout length, mean rate of licking during bouts, lick rate in first two minutes after first lick
